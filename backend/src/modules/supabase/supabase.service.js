...
var SupabaseService = function () {
    ...
    var SupabaseService = _classThis = /** @class */ (function () {
        function SupabaseService_1(configService) {
            ...
            this.client = (0, supabase_js_1.createClient)(this.configService.getOrThrow('SUPABASE_URL'), this.configService.getOrThrow('SUPABASE_SERVICE_ROLE_KEY'));
        }
        Object.defineProperty(SupabaseService_1.prototype, "clientRef", {
            get: function () {
                return this.client;
            },
            enumerable: false,
