...
var ClientsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Clients'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('clients')];
    ...
    (function () {
        ...
        _getMyProfile_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get my client profile' })];
