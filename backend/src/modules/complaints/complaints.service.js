...
var ComplaintsService = function () {
    ...
    var _classThis;
    var ComplaintsService = _classThis = /** @class */ (function () {
        function ComplaintsService_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        ComplaintsService_1.prototype.create = function (userId, dto) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.supabaseService.clientRef
                                .from('complaints')
                                .insert(__assign(__assign({ user_id: userId }, dto), { status: 'pending' }))];
                        case 1:
                            error = (_a.sent()).error;
                            if (error)
                                throw new Error('Failed to create complaint');
                            return [2 /*return*/, { message: 'Complaint submitted successfully' }];
                    }
                });
            });
        };
        return ComplaintsService_1;
    }());
