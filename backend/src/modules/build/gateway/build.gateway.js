...
var BuildGateway = function () {
    ...
    var BuildGateway = _classThis = /** @class */ (function () {
        function BuildGateway_1() {
            this.server = __runInitializers(this, _server_initializers, void 0);
            __runInitializers(this, _server_extraInitializers);
        }
        BuildGateway_1.prototype.emitBuildCreated = function (payload) {
            this.server.emit('build_created', payload);
        };
        BuildGateway_1.prototype.emitBuildUpdated = function (payload) {
            this.server.emit('build_updated', payload);
        };
        BuildGateway_1.prototype.emitToBuild = function (buildId, event, payload) {
            this.server.to(buildId).emit(event, payload);
        };
        return BuildGateway_1;
    }());
    __setFunctionName(_classThis, "BuildGateway");
    (function () {
        ...
        BuildGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BuildGateway = _classThis;
}();
