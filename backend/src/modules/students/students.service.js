...
var StudentsService = function () {
    ...
    var StudentsService = _classThis = /** @class */ (function () {
        function StudentsService_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        StudentsService_1.prototype.getProfile = function (userId) {
        ...
        StudentsService_1.prototype.getById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
        ...
        StudentsService_1.prototype.getEnrollments = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var student, _a, data, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.supabaseService.clientRef
                                .from('students')
