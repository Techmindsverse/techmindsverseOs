...
var ProjectsService = function () {
    ...
    var ProjectsService = _classThis = /** @class */ (function () {
        function ProjectsService_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        ProjectsService_1.prototype.submit = function (userId, dto) {
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.supabaseService.clientRef
                                    .from('projects')
                                    .insert(__assign(__assign({ student_id: student.id }, dto), { status: 'submitted' }))
                                    .select().single()];
                        case 2:
