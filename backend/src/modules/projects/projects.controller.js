...
var ProjectsController = function () {
    ...
    var ProjectsController = _classThis = /** @class */ (function () {
        ...
        ProjectsController_1.prototype.submit = function (user, dto) {
            return this.projectsService.submit(user.id, dto);
        };
    ...
    (function () {
        ...
        _submit_decorators = [(0, common_1.Post)('submit'), (0, swagger_1.ApiOperation)({ summary: 'Submit a project' })];
