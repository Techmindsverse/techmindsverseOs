...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        function PaymentsService_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        PaymentsService_1.prototype.createPayment = function (userId, dto) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, this.supabaseService.clientRef
                                ...
                                proof_image_url: (_b = dto.proof_image_url) !== null && _b !== void 0 ? _b : null,
                                status: 'pending',
                            })
                                .select()
                                .single()];
        ...
        PaymentsService_1.prototype.getMyPayments = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error;
