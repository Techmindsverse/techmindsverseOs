...
var admin_public_controller_1 = require("./admin-public.controller");
var build_module_1 = require("../build/build.module");
...
var AdminModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                build_module_1.BuildModule, // ✅ now properly exports BuildService
                auth_module_1.AuthModule,
                supabase_module_1.SupabaseModule,
                mail_module_1.MailModule,
            ],
            controllers: [admin_controller_1.AdminController, admin_public_controller_1.AdminPublicController],
