...
var AppController = function () {
    ...
    (function () {
        ...
        _getRoot_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'API root' })];
        _health_decorators = [(0, common_1.Get)('health'), (0, swagger_1.ApiOperation)({ summary: 'Health check' })];
