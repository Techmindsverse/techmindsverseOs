...
function ContactForm() {
  ...
  const [form, setForm] = useState({
    name: '',
    email: '',
    subject: serviceParam ? `Interested in: ${serviceParam}` : '',
    message: serviceParam ? `Hi, I'm interested in the ${serviceParam} service. ` : '',
  });
  ...
  return (
    <section className="py-32 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-bebas text-6xl md:text-8xl text-white mt-2 mb-2">CONTACT US</h1>
        <p className="text-white/40 mb-12 leading-relaxed">
          {serviceParam
            ? `You selected: ${serviceParam}. Fill in your details and we will get back to you.`
            : 'Partnerships, service inquiries, or just want to say hello.'}
        </p>
