...
const courses = [
  ...
  },
  {
    ...
    type: 'Media',
    description: 'CapCut, Premiere Pro, short-form content, storytelling, and brand advertisement videos.',
  ...
  },
  {
    ...
    type: 'AI & Automation',
    description: 'ChatGPT, Midjourney, AI video tools, automation workflows — use AI to scale your work.',
  ...
  return (
    <PublicLayout>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-bebas text-5xl text-white mb-12">AVAILABLE COURSES</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {courses.map((course, i) => (
              <div
                key={i}
                className="border border-white/10 p-8 hover:border-brand-blue/40 transition-colors group"
              >
                ...
                <h3 className="font-bebas text-2xl text-white mb-3">{course.title}</h3>
                <p className="text-white/40 text-sm leading-relaxed mb-6">{course.description}</p>
                <div className="border-t border-white/5 pt-4 mt-auto">
                  <p className="text-xs text-white/30 mb-4">Outcome: {course.outcome}</p>
                  <Link
                    href="/login"
      ...
      <section className="py-24 px-6 bg-white/[0.02] border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-bebas text-5xl text-white mb-12">HOW IT WORKS</h2>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: '01', title: 'Select Course', desc: 'Choose the track that matches your goals' },
              { step: '02', title: 'Make Payment', desc: 'Complete payment to secure your spot' },
              { step: '03', title: 'Get Access', desc: 'Admin approves and activates your account' },
              { step: '04', title: 'Start Learning', desc: 'Access dashboard, lessons, and projects' },
            ].map((item, i) => (
              <div key={i} className="border border-white/5 p-6">
                <div className="font-bebas text-4xl text-brand-blue/30 mb-4">{item.step}</div>
      ...
      <section className="py-24 px-6 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-bebas text-6xl text-white mb-4">READY TO START?</h2>
          <p className="text-white/40 mb-8">Join TechMindsVerse Academy and build real skills through real projects.</p>
          <Link
            href="/contact"
