    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center px-6">
        <div className="text-center">
          <h2 className="font-bebas text-4xl text-white mb-4">INVALID RESET LINK</h2>
          <p className="text-white/40 mb-8">This reset link is invalid or missing.</p>
          <Link href="/forgot-password" className="text-brand-blue hover:underline text-sm">
            Request a new one
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-bebas text-4xl text-white">RESET PASSWORD</h1>
