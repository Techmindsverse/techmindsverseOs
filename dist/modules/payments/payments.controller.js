...
let PaymentsController = class PaymentsController {
    constructor(paymentsService, storageUtil) {
        this.paymentsService = paymentsService;
        this.storageUtil = storageUtil;
    }
    async createPayment(user, dto, file) {
        let proof_image_url;
        if (file) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Submit payment proof' }),
    (0, swagger_1.ApiConsumes)('multipart/form-data'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('proof_image', { storage: (0, multer_1.memoryStorage)() })),
